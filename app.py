...
st.markdown(
    ...
    <style>
        ...
        div[data-testid="stMetricLabel"] {{ color: {GRIS_TEXTO} !important; }}
        div[data-testid="stMetricValue"] {{ color: {AZUL_CLARO} !important; font-weight: 700; }}
        ...
        /* --- Acento azul de respaldo para sliders y radios (por si el theme no cargó) --- */
...
with tab1:
    ...
    fig.add_trace(go.Scatter(
        ...
        marker=dict(size=5, color=sharpe_sim, colorscale="Blues", showscale=True,
    ...
    fig.add_trace(go.Scatter(
        ...
        text=mu.index, textposition="top center", textfont=dict(size=10, color=GRIS_TEXTO),
    ...
    fig.update_layout(
        **{**PLOTLY_LAYOUT, "legend": dict(orientation="h", yanchor="bottom", y=1.02, xanchor="left", x=0)},
        ...
        yaxis=dict(tickformat=".0%", gridcolor="rgba(255,255,255,0.07)"),
        height=560,
    )
...
with tab2:
    ...
    with col_izq:
        ...
        fig_bar.update_layout(
            **PLOTLY_LAYOUT,
            ...
            title="Distribución del gasto óptimo por proveedor",
        )
    ...
    with col_der:
        ...
        fig_pie.update_layout(**PLOTLY_LAYOUT, title="Concentración por categoría", height=380)
